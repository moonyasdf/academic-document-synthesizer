...
An AI-powered system that drafts and iteratively refines structured academic documents, optimized for Google's Gemini models and driven by a schema-validated JSON plan to ensure safe and deterministic refinements. Inspired by the [IMO 2025 Problem Solver repository.](https://github.com/lyang36/IMO25)
